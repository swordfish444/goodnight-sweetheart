...
- `Alexa, open nightly wishes`
- `Alexa, ask nightly wishes to set my bedtime to 10 PM`
- `Alexa, ask nightly wishes to set weekdays to 10 PM`
- `Alexa, ask nightly wishes to set Monday bedtime for 9:30 PM`
- `Alexa, ask nightly wishes what my bedtime schedule is`
- `Alexa, ask nightly wishes what time my bedtime is tonight`
- `Alexa, ask nightly wishes what time do I go to bed`
- `Alexa, ask nightly wishes to clear my bedtime on Friday`
